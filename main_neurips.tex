...
(\emph{proof are in Appendix ~\ref{proof}}).
...
unseen cases under the same split as prior work, resulting 10\%
...
and aerospace anomaly detection. Future work will pursue these directions.directions.
